...
CREATE TABLE IF NOT EXISTS `caracteristicas` (
  ...
  `valor` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando datos para la tabla sistema.carrito_item: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema.chatbot_accion: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `chatbot_mensaje` (
  ...
  `sesion_id` int DEFAULT NULL,
  `emisor` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando datos para la tabla sistema.chatbot_mensaje: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema.chatbot_sesion: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `cotizacion` (
  ...
  `tipo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'cliente',
  `admin_nombre` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_correo` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_telefono` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando datos para la tabla sistema.cotizacion: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema.detalle_cotizacion: ~8 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  `stock` int DEFAULT '0',
  `certificacion` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
